...
echo "<div class='row'>
			<div class='col-lg-12'>
				<div class='panel panel-default'>
					<div class='panel-heading'>Data Arsip Keluar</div>
					<div class='panel-body'>
						<table data-toggle='table' data-show-refresh='true' data-show-toggle='true' data-show-columns='true' data-search='true' data-select-item-name='toolbar1' data-pagination='true' data-sort-name='tgl_arsip' data-sort-order='desc'>
							...
							<tbody>";
							$tp=mysql_query('SELECT * FROM view_arsip where a_masuk="Arsip Keluar" ORDER BY no_arsip ASC');
							while($r=mysql_fetch_array($tp)){
                             ...
                             echo"<tr>
                                    ...
                                    <td>$r[nm_file]</td>
									<td>$r[lokasiarsip]</td>
                                    <td><a class='btn btn-danger' href='$aksi?act=hapus&id=$r[no_arsip]'>HAPUS</a></td>
                                </tr>";
							}
						echo "</tbody>
						</table>
