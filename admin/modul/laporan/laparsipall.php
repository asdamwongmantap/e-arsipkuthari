<?php
    ...
    $query ="select no_arsip, tgl_arsip, perihal, lampiran, desc_jenis, lokasiarsip from view_arsip";
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell(35,1,'LAPORAN DATA ARSIP KESELURUHAN',"",1,'C',1); //TBLR (untuk garis)=> B = Bottom,
            // L = Left, R = Right
