<?php
    ...
    $query ="select no_arsip, tgl_arsip, perihal, lampiran, desc_jenis, lokasiarsip, a_masuk from view_arsip WHERE a_masuk='Arsip Keluar'";
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->Cell(34,1,'LAPORAN DATA ARSIP KELUAR',"",1,'C',1); //TBLR (untuk garis)=> B = Bottom,
            // L = Left, R = Right
